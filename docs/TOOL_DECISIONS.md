...
| Durable work | PostgreSQL queue rows, `SKIP LOCKED`, worker | The state already lives in PostgreSQL and the expected workload does not justify a second queueing system. | FastAPI background tasks, Celery/Redis. |
